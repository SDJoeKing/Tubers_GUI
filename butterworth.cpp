...
std::vector<double> ComputeDenCoeffs(const int &FilterOrder,const  double &Lcutoff, const  double &Ucutoff)
{
...
std::vector<double> TrinomialMultiply(const int &FilterOrder,const  std::vector<double> &b, const std::vector<double> &c)
{
	int i, j;
...
std::vector<double> ComputeNumCoeffs(const int &FilterOrder, const double &Lcutoff, const double &Ucutoff, const std::vector<double> &DenC)
{
    ...
    for (int n = 0; n < FilterOrder * 2 + 1; n++)
		Numbers.push_back(n);
	int i;
...
std::vector<double> filter(const std::vector<double>& x, const std::vector<double> &coeff_b, const std::vector<double> &coeff_a)
{
	int len_x = x.size();
...
std::vector<double> ComputeLP(const int &FilterOrder)
{
...
std::vector<double> ComputeHP(const int &FilterOrder)
{
